...
export function showAestheticNotice() {
  ...
  const EXPIRY_DATE_STRING = '2026-1-3';             // 在此日期之后，提示将不再显示
  const ISSUE_URL = 'https://github.com/FwindEmi86/MiragEdge-DocWeb/issues/new?template=issue_template.yml'; // 项目提交 issue 的地址
